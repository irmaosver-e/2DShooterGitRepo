...
<tileset version="1.2" tiledversion="1.3.5" name="Cursor" tilewidth="32" tileheight="32" spacing="2" margin="2" tilecount="6" columns="6">
 <image source="Cursors.png" width="206" height="36"/>
 <tile id="0" type="mousepointer">
